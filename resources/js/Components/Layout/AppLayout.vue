                    ...
                    <template v-if="user">
                        <div class="flex items-center px-4">
                            ...
                            <button
                                v-if="isMounted"
                                @click="toggleDarkMode"
                                class="ml-auto rounded-md p-2 text-gray-600 hover:bg-gray-100 hover:text-gray-700 dark:text-gray-300 dark:hover:bg-gray-700 dark:hover:text-gray-200"
                                :title="isDark ? 'Switch to light mode' : 'Switch to dark mode'"
                                :aria-label="isDark ? 'Switch to light mode' : 'Switch to dark mode'"
                            >
                                <svg v-if="isDark" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
                        ...
                        <div class="mt-3 space-y-1 px-2">
                            <Link
                                href="/dashboard"
                                class="block rounded-md px-3 py-2 text-base font-medium text-gray-600 hover:bg-gray-50 hover:text-gray-800 dark:text-gray-300 dark:hover:bg-gray-700 dark:hover:text-gray-100"
                            >
                                Dashboard
                            </Link>
                            <Link
                            ...
                            <Link
                                v-if="!hasPaid"
                                href="/support"
                                class="block rounded-md px-3 py-2 text-base font-medium text-blue-600 hover:bg-blue-50 dark:text-blue-400 dark:hover:bg-gray-700"
                            >
                                Support Us
                            </Link>
                            <div v-else class="px-3 py-2 text-base font-medium text-green-600 dark:text-green-400">
                                Supporter
                            </div>
                            <Link
                                href="/logout"
                                method="post"
                                as="button"
                                class="block w-full rounded-md px-3 py-2 text-left text-base font-medium text-gray-600 hover:bg-gray-50 hover:text-gray-800 dark:text-gray-300 dark:hover:bg-gray-700 dark:hover:text-gray-100"
                            >
                                Sign out
                            </Link>
                        </div>
