    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$1, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(unref(Head), { title: "Create Account" }, null, _parent2, _scopeId));
            _push2(`<div class="flex min-h-[calc(100vh-200px)] flex-col justify-center py-12 sm:px-6 lg:px-8"${_scopeId}><div class="sm:mx-auto sm:w-full sm:max-w-md"${_scopeId}><h2 class="text-center text-3xl font-bold tracking-tight text-gray-900"${_scopeId}> Create your account </h2><p class="mt-2 text-center text-sm text-gray-600"${_scopeId}> Already have an account? `);
            ...
            _push2(`</p></div><div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md"${_scopeId}><div class="bg-white px-4 py-8 shadow sm:rounded-lg sm:px-10"${_scopeId}><form class="space-y-6"${_scopeId}><div${_scopeId}><label for="name" class="block text-sm font-medium text-gray-700"${_scopeId}> Full name </label><div class="mt-1"${_scopeId}><input id="name"${ssrRenderAttr("value", unref(form).name)} type="text" autocomplete="name" required class="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm"${_scopeId}></div>`);
            if (unref(form).errors.name) {
              _push2(`<p class="mt-2 text-sm text-red-600"${_scopeId}>${ssrInterpolate(unref(form).errors.name)}</p>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div${_scopeId}><label for="email" class="block text-sm font-medium text-gray-700"${_scopeId}> Email address </label><div class="mt-1"${_scopeId}><input id="email"${ssrRenderAttr("value", unref(form).email)} type="email" autocomplete="email" required class="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm"${_scopeId}></div>`);
            if (unref(form).errors.email) {
              _push2(`<p class="mt-2 text-sm text-red-600"${_scopeId}>${ssrInterpolate(unref(form).errors.email)}</p>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div${_scopeId}><label for="password" class="block text-sm font-medium text-gray-700"${_scopeId}> Password </label><div class="mt-1"${_scopeId}><input id="password"${ssrRenderAttr("value", unref(form).password)} type="password" autocomplete="new-password" required class="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm"${_scopeId}></div>`);
            if (unref(form).errors.password) {
              _push2(`<p class="mt-2 text-sm text-red-600"${_scopeId}>${ssrInterpolate(unref(form).errors.password)}</p>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div${_scopeId}><label for="password_confirmation" class="block text-sm font-medium text-gray-700"${_scopeId}> Confirm password </label><div class="mt-1"${_scopeId}><input id="password_confirmation"${ssrRenderAttr("value", unref(form).password_confirmation)} type="password" autocomplete="new-password" required class="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm"${_scopeId}></div></div><div${_scopeId}><button type="submit"${ssrIncludeBooleanAttr(unref(form).processing) ? " disabled" : ""} class="flex w-full justify-center rounded-md bg-blue-600 px-4 py-2 text-sm font-semibold text-white shadow-sm hover:bg-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600 disabled:bg-blue-400 disabled:cursor-not-allowed"${_scopeId}>`);
            ...
            return [
              createVNode(unref(Head), { title: "Create Account" }),
              createVNode("div", { class: "flex min-h-[calc(100vh-200px)] flex-col justify-center py-12 sm:px-6 lg:px-8" }, [
                createVNode("div", { class: "sm:mx-auto sm:w-full sm:max-w-md" }, [
                  createVNode("h2", { class: "text-center text-3xl font-bold tracking-tight text-gray-900" }, " Create your account "),
